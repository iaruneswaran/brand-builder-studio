...
const ARROW_ICONS: string[] = [
  ...
  'circle-caret-left', 'circle-caret-right', 'circle-caret-up', 'circle-chevron-left',
...
const arrowLegacySet = new Set([
  ...
  'circle-caret-left','circle-caret-right','circle-caret-up','circle-chevron-left','circle-chevron-right','circle-chevron-up','circle-chevrons-down','circle-chevrons-left',
